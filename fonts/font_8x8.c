...
// Each glyph: 8 bytes (rows), bit0 = leftmost pixel
static const uint8_t font_8x8_data[128][8] = {
    ...
    ['1'] = {0x0C,0x0E,0x0C,0x0C,0x0C,0x0C,0x3E,0x00},
    ['2'] = {0x3C,0x66,0x60,0x30,0x18,0x0C,0x7E,0x00},
    ['3'] = {0x3C,0x66,0x60,0x38,0x60,0x66,0x3C,0x00},
    ['4'] = {0x30,0x38,0x3C,0x36,0x7E,0x30,0x78,0x00},
    ...
    ['b'] = {0x00,0x06,0x06,0x3E,0x66,0x66,0x3E,0x00},
    ['c'] = {0x00,0x00,0x3C,0x66,0x06,0x66,0x3C,0x00},
    ['d'] = {0x00,0x60,0x60,0x7C,0x66,0x66,0x7C,0x00},
    ['e'] = {0x00,0x00,0x3C,0x66,0x7E,0x06,0x3C,0x00},
    ['f'] = {0x00,0x38,0x0C,0x0C,0x3E,0x0C,0x0C,0x00},
    ['g'] = {0x00,0x00,0x7C,0x66,0x7C,0x60,0x3C,0x00},
    ['h'] = {0x00,0x06,0x06,0x3E,0x66,0x66,0x66,0x00},
    ['i'] = {0x00,0x18,0x00,0x1C,0x18,0x18,0x3C,0x00},
    ['j'] = {0x00,0x30,0x00,0x30,0x30,0x36,0x1C,0x00},
    ['k'] = {0x00,0x06,0x66,0x36,0x1E,0x36,0x66,0x00},
    ['l'] = {0x00,0x0E,0x0C,0x0C,0x0C,0x0C,0x3E,0x00},
    ['m'] = {0x00,0x00,0x37,0x7F,0x6B,0x63,0x63,0x00},
    ['n'] = {0x00,0x00,0x3E,0x66,0x66,0x66,0x66,0x00},
    ['o'] = {0x00,0x00,0x3C,0x66,0x66,0x66,0x3C,0x00},
    ['p'] = {0x00,0x00,0x3E,0x66,0x3E,0x06,0x06,0x00},
    ['q'] = {0x00,0x00,0x7C,0x66,0x7C,0x60,0x60,0x00},
    ['r'] = {0x00,0x00,0x3E,0x66,0x06,0x06,0x06,0x00},
    ['s'] = {0x00,0x00,0x3C,0x06,0x3C,0x60,0x3E,0x00},
    ['t'] = {0x00,0x18,0x7E,0x18,0x18,0x18,0x70,0x00},
    ['u'] = {0x00,0x00,0x66,0x66,0x66,0x66,0x7C,0x00},
    ['v'] = {0x00,0x00,0x66,0x66,0x66,0x3C,0x18,0x00},
    ['w'] = {0x00,0x00,0x63,0x6B,0x7F,0x77,0x63,0x00},
    ['x'] = {0x00,0x00,0x66,0x3C,0x18,0x3C,0x66,0x00},
    ['y'] = {0x00,0x00,0x66,0x66,0x7C,0x60,0x3C,0x00},
